...
@else
    <div x-data="{
        ...
        <button type="button" id="filament-language-switcher" x-on:click="toggleDropdown()"
            class="flex items-center justify-center gap-2 h-10 px-3 min-w-10 rounded-md ring-1 ring-gray-950/10 dark:ring-white/20 transition hover:bg-yellow-400 hover:text-gray-900 focus:bg-yellow-400 focus:text-gray-900"
            x-tooltip="{
                    content: '{{ __('Change Language') }}',
                    theme: document.documentElement.classList.contains('dark') ? 'dark' : 'light'
                }">
