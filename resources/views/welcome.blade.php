                    ...
                    @auth
                        <li class="w-full lg:w-auto">
                            <a href="{{ \App\Providers\NativeServiceProvider::normalizeUrl(route('filament.user.resources.home.index', ['record' => 1])) }}"
                                ...
                                class="items-center justify-center dark:bg-white dark:text-gray-950 dark:hover:bg-gray-200 hover:bg-black hover:border-black px-5 py-2.5 bg-gray-900 rounded-sm border border-black text-white text-sm font-semibold leading-normal transition-all active:scale-95 shadow-sm w-full lg:w-auto">
                                {{ __('Buka Beranda') }}
                            </a>
                        </li>
                    @else
                        @if(\App\Providers\NativeServiceProvider::isAnyMobile())
                            ...
                            <li class="w-full lg:w-auto">
                                <a href="{{ route('filament.user.auth.register') }}"
                                    style="display: flex; position: relative; z-index: 10; cursor: pointer;"
                                    class="items-center justify-center dark:bg-gray-800 dark:text-white dark:hover:bg-gray-700 hover:bg-gray-100 px-5 py-2.5 bg-white rounded-sm border border-gray-300 text-gray-900 text-sm font-semibold leading-normal transition-all active:scale-95 shadow-sm w-full lg:w-auto">
                                    {{ __('Daftar') }}
                                </a>
                            </li>
                            <li class="w-full lg:w-auto">
                                <a href="{{ route('auth.redirect', ['provider' => 'google']) }}"
                                    style="display: flex; position: relative; z-index: 10; cursor: pointer;"
                                    class="items-center justify-center gap-2 dark:bg-white dark:text-gray-950 dark:hover:bg-gray-200 hover:bg-gray-100 px-5 py-2.5 bg-white rounded-sm border border-gray-300 text-gray-900 text-sm font-semibold leading-normal transition-all active:scale-95 shadow-sm w-full lg:w-auto">
