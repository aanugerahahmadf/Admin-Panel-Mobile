        ...
        <div class="flex items-center justify-center w-full min-h-full p-6 lg:p-8">
            ...
            <div
                ...
                <ul class="flex flex-col items-center lg:flex-row lg:justify-start w-full mt-4 lg:mt-6 gap-3" style="position: relative; z-index: 10;">
                    ...
                    @auth
                        <li class="{{ $btnClass }}">
                            <a href="{{ \App\Providers\NativeServiceProvider::normalizeUrl(route('filament.user.resources.home.index', ['record' => \App\Models\WeddingOrganizer::value('id') ?? 1])) }}"
                    ...
                    @else
                        ...
                        <li class="{{ $btnClass }}">
                            <a href="{{ \App\Providers\NativeServiceProvider::normalizeUrl(route('auth.redirect', ['provider' => 'google'])) }}"
                                style="display: flex; position: relative; z-index: 10; cursor: pointer;"
